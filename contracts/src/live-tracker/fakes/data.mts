import type { LiveTrackerStateMessage } from "../types.mts";

const players: LiveTrackerStateMessage["data"]["players"] = [
...
const teams: LiveTrackerStateMessage["data"]["teams"] = [
  {
    name: "Team 1",
...
const discoveredMatches: LiveTrackerStateMessage["data"]["discoveredMatches"] = [
  {
