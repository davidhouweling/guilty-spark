...
describe("MapsCommand", () => {
  ...
  describe("/maps basic usage", () => {
    it("returns a set of 5 maps by default", () => {
      ...
      expect(buttonRow?.components.length).toBe(4);
      expect(getButtonById(buttonRow, InteractionButton.Roll5)?.style).toBe(1); // Primary
    });
    ...
    it("returns a set of 3 maps when count=3", () => {
      ...
      expect(getButtonById(buttonRow3, InteractionButton.Roll3)?.style).toBe(1);
    });
    ...
    it("returns a set of 7 maps when count=7", () => {
      ...
      expect(getButtonById(buttonRow7, InteractionButton.Roll7)?.style).toBe(1);
    });
  });
  ...
  describe("/maps button interaction", () => {
    ...
    it("regenerates maps with correct count and playlist when button is pressed", () => {
      ...
      expect(getButtonById(buttonRowHist, InteractionButton.Roll3)?.style).toBe(1);
    });
