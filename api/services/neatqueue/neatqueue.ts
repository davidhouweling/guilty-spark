...
export class NeatQueueService {
  ...
  private async postSeriesDataByThread({
    ...
    try {
      ...
      await Promise.all([
        ...
        this.persistLeaderboardSeriesData({ request, neatQueueConfig, series }),
  ...
  private async persistLeaderboardSeriesData({
    request,
    neatQueueConfig,
    series,
  }: {
    ...
    const { databaseService, haloService, logService } = this;
    ...
    try {
      ...
      const seriesRow: LeaderboardSeriesRow = {
        ...
        SeriesScore: haloService.getSeriesScore(sortedSeries, this.locale),
        Source: "neatqueue",
        CreatedAt: nowEpoch,
        UpdatedAt: nowEpoch,
      };
