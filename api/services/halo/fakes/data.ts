...
import type { SeriesData, MatchHistoryEntry } from "../types";
...
export function aFakeMatchHistoryEntryWith(overrides?: Partial<MatchHistoryEntry>): MatchHistoryEntry {
  ...
  return {
    ...
    mapAssetId: baseMatch.MatchInfo.MapVariant.AssetId,
    mapVersionId: baseMatch.MatchInfo.MapVariant.VersionId,
    modeAssetId: baseMatch.MatchInfo.UgcGameVariant.AssetId,
    modeVersionId: baseMatch.MatchInfo.UgcGameVariant.VersionId,
    gameVariantCategory: baseMatch.MatchInfo.GameVariantCategory,
    mapName: "Live Fire",
    modeName: "Slayer",
    outcome: "Win",
