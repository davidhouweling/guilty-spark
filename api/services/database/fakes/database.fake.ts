...
export function aFakeLeaderboardGamePlayersRow(
  ...
  const defaultOpts: LeaderboardGamePlayersRow = {
    ...
    MedalPoints: 1200,
    MythicMedalCount: 2,
    ObjectiveTimeSeconds: null,
    ObjectiveTeamContribution: null,
    ObjectiveGameContribution: null,
    ObjectiveStatsJson: "{}",
    MedalsJson: "[]",
    CreatedAt: Math.floor(Date.now() / 1000),
  };
...
export function aFakeLeaderboardPlayerStatsRow(
  ...
  const defaultOpts: LeaderboardPlayerStatsRow = {
    ...
    ObjectiveTeamContributionGamesPlayed: 30,
    ObjectiveGameContribution: 0.12,
    ObjectiveGameContributionGamesPlayed: 30,
    CtfGamesPlayed: 8,
