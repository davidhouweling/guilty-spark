...
VALUES
    ...
    ('1300001976334946326', 1004, '1352868353869352970', '1347857828341350480', unixepoch() - 43200, unixepoch() - 39600, 0, '3:1', 'neatqueue', unixepoch(), unixepoch());
...
VALUES
    ...
    ('1300001976334946326', 1004, '1352868353869352970', '2533274844642438', '162624842414292998', 'soundmanD', 0, 1, 0, 0, 1, 1, unixepoch()),
    ('1300001976334946326', 1004, '1352868353869352970', '2533274000000001', '162624842414292992', 'AlphaOne', 0, 1, 0, 0, 1, 1, unixepoch()),
    ('1300001976334946326', 1004, '1352868353869352970', '2533274000000002', '162624842414292993', 'BravoTwo', 1, 1, 0, 0, 1, 0, unixepoch());
...
VALUES
    ...
    ('match-1004-1', '1300001976334946326', 1004, '1352868353869352970', 1, 0, 'Slayer', 'Argentite', NULL, NULL, 100, 80, unixepoch() - 43200, unixepoch() - 41400, unixepoch());
...
VALUES
    ...
    ('match-1004-1', '1300001976334946326', 1004, '1352868353869352970', '2533274844642438', '162624842414292998', 'soundmanD', 0, 1, 1, 1, 2900, 22, 10, 8, 8, 2.2, 0.62, 95, 153, 3600, 2300, 1.57, 160.5, 39.0, 3, 330, 1, 146.0, 0.73, '{"objectiveTime":146,"objectiveScore":22}', '[]', unixepoch()),
    ('match-1004-1', '1300001976334946326', 1004, '1352868353869352970', '2533274000000001', '162624842414292992', 'AlphaOne', 0, 1, 1, 2, 2400, 16, 12, 6, 6, 1.33, 0.55, 76, 138, 3100, 2500, 1.24, 135.0, 28.0, 2, 240, 0, 110.0, 0.55, '{"objectiveTime":110,"objectiveScore":16}', '[]', unixepoch()),
    ('match-1004-1', '1300001976334946326', 1004, '1352868353869352970', '2533274000000002', '162624842414292993', 'BravoTwo', 1, 1, 0, 3, 1900, 12, 15, 4, 3, 0.8, 0.40, 50, 125, 2500, 3200, 0.78, 110.0, 20.0, 1, 100, 0, 80.0, 0.30, '{"objectiveTime":80,"objectiveScore":10}', '[]', unixepoch());

INSERT INTO MatchKillMatrix (MatchId, KillerXuid, VictimXuid, Count, Perfects, CreatedAt, UpdatedAt)
VALUES
    ('match-1004-1', '2533274844642438', '2533274000000002', 12, 2, unixepoch(), unixepoch()),
    ('match-1004-1', '2533274000000002', '2533274844642438', 5, 0, unixepoch(), unixepoch());
